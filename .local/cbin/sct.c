 ...
 *  from https://flak.tedunangst.com/post/sct-set-color-temperature
 *
 *  cflags: -std=c99 -O2 -I /usr/X11R6/include -o ~/.local/bin/sct sct.c 
 *          -L /usr/X11/R6/lib -lm -lX11 -lXrandr
 */
