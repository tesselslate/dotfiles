-- neovim config
-- theme/colors/nordfox.lua
--
-- from https://github.com/EdenEast/nightfox.nvim/blob/main/lua/nightfox/precompiled/nvim/nordfox_compiled.lua
...
vim.api.nvim_set_hl(0, "Normal", { fg = "#cdcecf" })
