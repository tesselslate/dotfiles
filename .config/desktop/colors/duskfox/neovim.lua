...
local hls = {
    ...
    ["@constructor"] = { fg = "#c4a7e7" },
    ["@text.danger"] = { fg = "#eb6f92" },
    ["@error"] = { fg = "#eb6f92" },
    ["@field"] = { fg = "#569fba" },
    ["@function.builtin"] = { fg = "#eb6f92" },
    ["@function.macro"] = { fg = "#eb6f92" },
    ["@keywordFunction"] = { fg = "#eb6f92" },
    ["@keywordOperator"] = { fg = "#cdcbe0" },
    ["@namespace"] = { fg = "#a6dae3" },
    ["@text.note"] = { fg = "#569fba" },
    ["@operator"] = { fg = "#cdcbe0" },
    ["@property"] = { link = "@field" },
    ...
    ["@punctuation.special"] = { fg = "#cdcbe0" },
    ["@stringEscape"] = { fg = "#f9cb8c" },
    ["@stringRegex"] = { fg = "#f9cb8c" },
    ["@textReference"] = { fg = "#c4a7e7" },
    ["@typeBuiltin"] = { fg = "#a6dae3" },
    ["@text.uri"] = { fg = "#9ccfd8" },
    ["@variable"] = { fg = "#e0def4" },
    ["@variableBuiltin"] = { fg = "#eb6f92" },
    ["@text.warning"] = { fg = "#f6c177" },
