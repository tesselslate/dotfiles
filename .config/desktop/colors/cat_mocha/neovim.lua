...
local hls = {
    ...
    ["TSURI"] = { fg = "#F5E0DC", italic = true, underline = true },
    ["TSTypeBuiltin"] = { fg = "#F9E2AF" },
    ["TSTextReference"] = { bold = true, fg = "#B4BEFE" },
    ...
    ["TSNamespace"] = { fg = "#89B4FA", italic = true },
    ...
    ["Repeat"] = { fg = "#F38BA8" },
    ["QuickFixLine"] = { bg = "#45475A", bold = true },
    ["Question"] = { fg = "#89B4FA" },
    ["MoreMsg"] = { fg = "#89B4FA" },
    ...
    ["NvimTreeRootFolder"] = { bold = true, fg = "#89B4FA" },
    ["NotifyWARNTitle"] = { fg = "#F9E2AF", italic = true },
    ["TSTagAttribute"] = { fg = "#94E2D5", italic = true },
    ["NotifyWARNBorder"] = { fg = "#F9E2AF" },
    ["TSTag"] = { fg = "#CBA6F7" },
    ["NotifyTRACETitle"] = { fg = "#F5E0DC", italic = true },
    ["TSLiteral"] = { fg = "#94E2D5", italic = true },
    ["TSTitle"] = { bold = true, fg = "#89B4FA" },
    ["NotifyTRACEBorder"] = { fg = "#F5E0DC" },
    ["NotifyINFOTitle"] = { fg = "#89B4FA", italic = true },
    ...
    ["NotifyDEBUGTitle"] = { fg = "#FAB387", italic = true },
    ...
    ["DashboardFooter"] = { fg = "#F9E2AF", italic = true },
    ["DashboardCenter"] = { fg = "#A6E3A1" },
    ["PmenuSel"] = { bg = "#45475A", bold = true, fg = "#CDD6F4" },
    ...
    ["TSRepeat"] = { fg = "#CBA6F7" },
    ["TSConditional"] = { fg = "#CBA6F7", italic = true },
    ["Folded"] = { bg = "#45475A", fg = "#89B4FA" },
    ["FoldColumn"] = { fg = "#6C7086" },
    ["TSMethod"] = { fg = "#89B4FA" },
    ["FloatBorder"] = { fg = "#89B4FA" },
    ["TSParameter"] = { fg = "#EBA0AC", italic = true },
    ["TSFunction"] = { fg = "#89B4FA" },
    ["TSFloat"] = { fg = "#FAB387" },
    ["TSBoolean"] = { fg = "#FAB387" },
    ["TSNumber"] = { fg = "#FAB387" },
    ["MiniStarterFooter"] = { fg = "#F9E2AF", italic = true },
    ...
    ["Bold"] = { bold = true },
    ["CmpItemAbbrMatch"] = { bold = true, fg = "#CDD6F4" },
    ["CmpItemAbbrMatchFuzzy"] = { bold = true, fg = "#CDD6F4" },
    ["MiniStarterInactive"] = { fg = "#585B70", italic = true },
    ["MiniStarterQuery"] = { fg = "#A6E3A1" },
    ["MiniStarterCurrent"] = {},
    ["DiagnosticVirtualTextError"] = { bg = "NONE", fg = "#F38BA8", italic = true },
    ["LspSignatureActiveParameter"] = { fg = "#FAB387" },
    ["Include"] = { fg = "#F5C2E7" },
    ["DiagnosticVirtualTextInfo"] = { bg = "NONE", fg = "#89DCEB", italic = true },
    ...
    ["Character"] = { fg = "#94E2D5" },
    ["DiagnosticError"] = { bg = "NONE", fg = "#F38BA8", italic = true },
    ["Comment"] = { fg = "#585B70", italic = true },
    ["DiagnosticWarn"] = { bg = "NONE", fg = "#F9E2AF", italic = true },
    ["WarningMsg"] = { fg = "#F9E2AF" },
    ["DiagnosticInfo"] = { bg = "NONE", fg = "#89DCEB", italic = true },
    ["DiagnosticHint"] = { bg = "NONE", fg = "#94E2D5", italic = true },
    ["MiniStatuslineModeCommand"] = { bg = "#FAB387", bold = true, fg = "#1E1E2E" },
    ...
    ["MiniJump2dSpot"] = { bg = "#1E1E2E", bold = true, fg = "#FAB387", underline = true },
    ...
    ["MiniTestPass"] = { bold = true, fg = "#A6E3A1" },
    ...
    ["MiniTablineModifiedCurrent"] = { bg = "#CDD6F4", bold = true, fg = "#1E1E2E", italic = true },
    ["MiniTablineHidden"] = { bg = "NONE", fg = "#CDD6F4" },
    ["MiniTablineFill"] = { bg = "NONE" },
    ["MiniTablineCurrent"] = { bg = "#1E1E2E", bold = true, fg = "#CDD6F4", italic = true },
    ["yamlTSField"] = { fg = "#89B4FA" },
    ["MiniStatuslineModeVisual"] = { bg = "#CBA6F7", bold = true, fg = "#1E1E2E" },
    ["MiniStatuslineModeReplace"] = { bg = "#F38BA8", bold = true, fg = "#1E1E2E" },
    ["MiniStatuslineModeOther"] = { bg = "#94E2D5", bold = true, fg = "#1E1E2E" },
    ["MiniStatuslineModeNormal"] = { bg = "#89B4FA", bold = true, fg = "#181825" },
    ["MiniStatuslineModeInsert"] = { bg = "#A6E3A1", bold = true, fg = "#1E1E2E" },
    ...
    ["MsgArea"] = { fg = "#CDD6F4" },
    ["TabLineFill"] = {},
    ["Title"] = { bold = true, fg = "#89B4FA" },
    ["VisualNOS"] = { bg = "#45475A", bold = true },
    ["Whitespace"] = { fg = "#45475A" },
    ["ErrorMsg"] = { bold = true, fg = "#F38BA8", italic = true },
    ["MsgSeparator"] = {},
    ...
    ["MatchParen"] = { bold = true, fg = "#FAB387" },
    ["PmenuSbar"] = { bg = "#45475A" },
    ["debugPC"] = { bg = "#11111B" },
    ...
    ["DiagnosticVirtualTextHint"] = { bg = "NONE", fg = "#94E2D5", italic = true },
    ["WhichKeySeperator"] = { fg = "#6C7086" },
    ["WhichKeyValue"] = { fg = "#6C7086" },
    ["htmlH2"] = { bold = true, fg = "#89B4FA" },
    ["mkdCodeStart"] = { bold = true, fg = "#F2CDCD" },
    ["mkdCodeEnd"] = { bold = true, fg = "#F2CDCD" },
    ["TSConstant"] = { fg = "#FAB387" },
    ["Error"] = { fg = "#F38BA8" },
    ["Conditional"] = { fg = "#F38BA8" },
    ["NotifyERRORTitle"] = { fg = "#F38BA8", italic = true },
    ["NotifyERRORIcon"] = { fg = "#F38BA8" },
    ["Identifier"] = { fg = "#F2CDCD" },
    ["CmpItemKindConstructor"] = { fg = "#89B4FA" },
    ["Statement"] = { fg = "#CBA6F7" },
    ["TSEmphasis"] = { fg = "#EBA0AC", italic = true },
    ["TSStrong"] = { bold = true, fg = "#EBA0AC" },
    ...
    ["DiagnosticVirtualTextWarn"] = { bg = "NONE", fg = "#F9E2AF", italic = true },
    ...
    ["TSString"] = { fg = "#A6E3A1" },
    ["MiniTestFail"] = { bold = true, fg = "#F38BA8" },
    ...
    ["markdownHeadingDelimiter"] = { bold = true, fg = "#FAB387" },
    ...
    ["LspDiagnosticsVirtualTextHint"] = { fg = "#94E2D5", italic = true },
    ["LspDiagnosticsVirtualTextInformation"] = { fg = "#89DCEB", italic = true },
    ["LspDiagnosticsVirtualTextWarning"] = { fg = "#F9E2AF", italic = true },
    ["LspDiagnosticsVirtualTextError"] = { fg = "#F38BA8", italic = true },
