-- neovim config
-- theme/colors/dayfox.lua
--
-- from https://github.com/EdenEast/nightfox.nvim/blob/main/lua/nightfox/precompiled/nvim/dayfox_compiled.lua
...
vim.api.nvim_set_hl(0, "Normal", { fg = "#1d344f" })
