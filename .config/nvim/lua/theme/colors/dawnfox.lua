-- neovim config
-- theme/colors/dawnfox.lua
--
-- from https://github.com/EdenEast/nightfox.nvim/blob/main/lua/nightfox/precompiled/nvim/dawnfox_compiled.lua
...
vim.api.nvim_set_hl(0, "Normal", { fg = "#575279" })
